          ...
          <defs>
            {paths.map((path, index) => (
              ...
              >
                ...
                <stop offset="32.5%" stopColor="#B8860B"></stop> {/* 暗金色 */}
                <stop offset="100%" stopColor="#8B4513" stopOpacity="0"></stop>{/* 深棕色 */}
              </motion.linearGradient>
            ))}
            ...
            >
              <stop offset="0.0666667" stopColor="#C19A6B"></stop>{" "}
              {/* 浅金棕 */}
              <stop offset="0.243243" stopColor="#B68D40"></stop> {/* 中金棕 */}
