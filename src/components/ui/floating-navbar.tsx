  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <a href="https://www.linkedin.com/in/yi-li-dev/" target="_blank" className="bg-gradient-to-br from-[#B08642] to-[#D2A554] text-sm font-medium text-black px-4 py-2 rounded-full transition-all hover:shadow-[0px_0px_10px_rgba(210,165,84,0.5)]">
