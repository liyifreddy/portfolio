...
export const TechLogoGrid = () => {
  ...
  const technologies = [
    ...
    { name: "Pillow", logo: "/logos/pillow.png" },
    ...
    { name: "Tortoise", logo: "/logos/tortoise.png" },
    { name: "Ubuntu", logo: "/logos/ubuntu.png" },
    { name: "Vue.js", logo: "/logos/vuejs.png" },
    { name: "Vuetify", logo: "/logos/vuetify.png" },
    { name: "SLURM", logo: "/logos/slurm.png" },
  ];
